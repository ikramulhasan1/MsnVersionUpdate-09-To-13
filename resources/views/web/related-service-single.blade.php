...
@php
    ...
    @foreach ($services as $item)
        <section class="hero-section d-flex align-items-center justify-content-center text-center" style="background: url('{{ public_path('uploads/banner/') }}{{ $item->banner_image ?? '' }}') center/cover no-repeat; color: #fff; padding: 120px 0; position: relative;">
