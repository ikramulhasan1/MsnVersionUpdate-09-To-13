    ...
    <div id="modal-1" class="modal__overlay">
        <div class="modal__container">
            <header class="mb-4">
                ...
                <h2 class="text-center row d-flex justify-content-center align-items-center "
                    style="font-weight: bolder">
                    <div class="d-flex">
                        <img style="width: 30px !important; margin-right: 5px; "
                ...
                <h6 class="text-center" style="font-weight: bold">Select a Date and Time for the Meeting at Your
                    Convenience</h6>
            </header>
                ...
                <form id="modal-form">
                    <div class="row">
                        <div class="col-md-6 position-relative">
                            ...
                            <input type="email" id="email" name="email" class="form-control mb-3 mt-3"
                            ...
                            <input type="time" id="meeting_time" name="meeting_time" class="custom-input pl-2"
                                required />
                        </div>
