    ...
    <div class="msn-nav-row">
      <a href="{{ route('home') }}" class="msn-nav-logo">
        <img src="{{ asset('/uploads/setting/' . ($setting->logo_path ?? '')) }}"
          alt="{{ $setting->title ?? 'MSN Softtech' }}">
      </a>
      ...
      <ul class="msn-nav-links">
        ...
        <li class="has-drop">
          <a href="{{ route('services') }}">
            Services
            <svg class="msn-chev" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4"
            ...
            <div class="msn-mega-inner">
              <div class="msn-mega-left">
                @foreach($servicesMenu as $i => $service)
                  <button type="button" class="msn-mega-item{{ $i === 0 ? ' is-active' : '' }}"
                ...
                @endforeach
                <a href="{{ route('services') }}" class="msn-mega-item"
                  style="margin-top:8px;border-top:1px solid var(--msn-nav-border);border-radius:0;padding-top:14px;color:black;">
                  View all services →
                </a>
              </div>
      ...
      <div class="msn-nav-actions">
        ...
        <button type="button" class="msn-burger" id="msnBurger" aria-label="Toggle menu" aria-expanded="false"
          aria-controls="msnMobilePanel">
  ...
  <footer id="msn-footer">
    ...
    {{-- <div class="msn-footer-cta">
      <div class="container">
        ...
        <p>Tell us what you're trying to ship — we'll reply with a clear scope, timeline and a real quote, not a sales
          pitch.</p>
