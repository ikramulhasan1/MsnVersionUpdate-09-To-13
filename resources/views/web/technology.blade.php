...
@section('content')
  ...
  {{-- <section style="padding:20px 60px !important;" class="banner-container">
    <div class="banner-left">
      ...
      <p style="color: white">Hire our expert Python developers to build scalable web applications, data-driven solutions,
        and advanced machine learning models tailored to your business needs.</p>
    </div>
    ...
    <div class="banner-card">
      ...
      <div class="banner-info-box">
        ...
        <p style="color: white">Got a project in mind? Share your vision, and get a free expert consultation within 24
          hours—complete with a personalized roadmap tailored to your goals and budget.</p>
      </div>
    </div>
  </section>
  @if(isset($service))
          ...
          <aside class="sidebar services-sidebar">
            ...
            <div class="sidebar-widget sidebar-blog-category">
              <ul class="blog-cat">
                ...
                <li class="@if($service_list->id == $technology->id) active @endif"><a
                    href="{{ route('service.technology', $service_list->slug) }}">{!!
                    str_limit(strip_tags($service_list->title), 60, ' ...') !!}</a></li>
                @endforeach
              </ul>
            </div>
              ...
              <div class="image-box">
                <div class="single-item-">
                  <figure class="image"><img style="border-radius: 5px;"
                      src="{{ asset('uploads/service/'.$technology->image_path) }}" alt="{{ $technology->title }}" />
                  </figure>
                </div>
                ...
                <div class="single-item-">
                  <picture>
                    ...
                    <img style="border-radius: 5px;" src="{{ asset('uploads/service/'.$technology->image_path) }}"
      ...
      <div class="row clearfix mb-5">
        <div class="sidebar-side col-lg-5 col-md-12 col-sm-12">
          <aside class="sidebar services-sidebar">
            ...
            <div class="image-box">
              <div class="single-item-">
                <figure class="image"><img style="border-radius: 10px;"
                    src="{{ asset('uploads/service/'.$item->image_path) }}" alt="{{ $item->title }}" /></figure>
              </div>
            </div>
            <div class="image-box">
              <div class="single-item-">
                <figure class="image">
                  <picture>
                    ...
                    <img style="border-radius: 10px;" src="{{ asset('uploads/service/'.$item->image_path) }}"
                      alt="{{ $item->title }}" />
                  </picture>
                </figure>
              </div>
  ...
  <section class="discussion-section">
    <div class="discussion-container">
      ...
      <div class="discussion-left">
        <img style="height: 250px" src="{{ asset('uploads/technology/' . $technology->image_path) }}"
          ...
          <div class="col-md-3 col-sm-6">
            <div class="tech-pill">
              <img src="{{ asset('uploads/technology/' . $item['expertise_image']) }}" alt="" style="max-height:34px;"
                @if(!empty($item['expertise_url'])) onclick="window.location='{{ $item['expertise_url'] }}'"
