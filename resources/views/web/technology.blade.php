...
@section('title', content: $technology->meta_title)

@section('top_meta_tags')
@if(isset($technology->short_desc))
<meta name="description" content="{!! str_limit(strip_tags($technology->short_desc), 200, ' ...') !!}">
@else
<meta name="description" content="{!! str_limit(strip_tags($technology->short_desc), 200, ' ...') !!}">
@endif
{{-- 
<script type="application/ld+json">
    {
      ...
      "@type": "Product",
      "name": "{{ $technology->meta_title }}",
      "image": {
        "@type": "ImageObject",
        "url": "{{ asset('uploads/service/'.$technology->image_path) }}",
        "width": "100",
        "height": "100"
      },
      
      "description": "{{ Str::limit(strip_tags($technology->description), 500, '...') }}",
      "url": "{{ route('service.technology', $technology->slug) }}",
      "brand": {
        "@type": "Brand",
        "name": "MSN Softtech",
      ...
      "aggregateRating": {
        ...
        "ratingValue": "{{ $technology->average_rating }}",
        "bestRating": "5",
        "worstRating": "1",
        "ratingCount": "{{ $technology->review_count }}"
      },
      "review": {
        "@type": "Review",
        "author": {
        ...
        "datePublished": "{{ $technology->created_at->format('Y-m-d') }}",
        "reviewRating": {
          "@type": "Rating",
          "ratingValue": "5",
          "bestRating": "5",
        ...
        "reviewBody": "MSN Softtech delivered an exceptional custom {{ $technology->short_title }} solution that enhanced our online presence and improved performance."
      }
    }
    </script> --}}
...
@if(isset($technology->keywords))
<meta name="keywords" content="{!! strip_tags($technology->keywords) !!}">
@else
...
<meta property='og:description' content="{!! str_limit(strip_tags($technology->short_desc), 160, ' ...') !!}" />
<meta property='og:url' content="{{ route('service.technology', $technology->slug) }}" />
<meta property='og:image' content="{{ asset('uploads/service/'.$technology->image_path) }}" />


<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="{!! '@'.str_replace(' ', '', $setting->title) !!}" />
<meta name="twitter:creator" content="@MSNSOFTTECH" />
<meta name="twitter:url" content="{{ route('service.technology', $technology->slug) }}" />
<meta name="twitter:title" content="{{ $technology->meta_title }}" />
<meta name="twitter:description" content="{!! str_limit(strip_tags($technology->short_desc), 160, ' ...') !!}" />
<meta name="twitter:image" content="{{ asset('uploads/service/'.$technology->image_path) }}" />
@endif
@endsection
...
{{-- <section class="page-title">
    <div class="container">
        <div class="inner-container clearfix">
            <div class="title-box">
                <h1 style="font-size: 36px">{{ $technology->title }}</h1>
            </div>
...
{{-- <section style="padding:20px 60px !important;" class="banner-container">
    <div class="banner-left">
      <h1 style="color: white" >{{ $technology->short_title }}</h1>
    ...
    <div class="banner-card">
      <img src="{{ asset('uploads/service/'.$technology->logo_path) }}" alt="{{ $technology->title }}" />
...
<div style="background-color: #ffffff" class="sidebar-page-container">
    <div class="mx-5">
                ...
                <aside class="sidebar services-sidebar">
                    ...
                    <div class="sidebar-widget sidebar-blog-category">
                        <ul class="blog-cat">
                            ...
                            <li class="@if($service_list->id == $technology->id) active @endif"><a href="{{ route('service.technology', $service_list->slug) }}">{!! str_limit(strip_tags($service_list->title), 60, ' ...') !!}</a></li>
                            @endforeach
                        </ul>
                    </div>
                    ...
                    <div class="inner-box">
                        <div class="image-box">
                            <div class="single-item-">
                                <figure class="image"><img style="border-radius: 5px;" src="{{ asset('uploads/service/'.$technology->image_path) }}" alt="{{ $technology->title }}" /></figure>
                            </div>

                            <div class="single-item-">
                                <picture>
                                    <source type="image/webp" srcset="{{ asset('uploads/service/'.$technology->image_path.'.webp') }}">
                                    <img style="border-radius: 5px;" src="{{ asset('uploads/service/'.$technology->image_path) }}" alt="{{ $technology->title }}" />
                                </picture>
                            </div>
                            
                        </div>
                        <p style="font-size: 32px; color: black; font-weight: 500;" class="mb-4">{{ $technology->title }}</p>
        ...
        @if ($technology->subservices)
        @foreach ($technology->subservices as $key => $item)
        @php
...
@php
  $tech = json_decode($technology->tech_steps, true); 
  $expertise = json_decode($technology->expertise_steps, true); 
@endphp
{{--  --}}
<section class="hero">
    <!-- Left Side -->
  ...
  <!-- TOP SECTION -->
    <section class="py-5 text-center">
        <div class="container">
            <h1 style="font-weight: 900">Hire {{ $technology->short_title }} Developers to Create Interactive User Interfaces with Ease</h1>
            <p class="lead-text mt-3 mb-5">
                Our {{ $technology->short_title }} developers build intuitive user interfaces for websites and single-page applications,
                          ...
                          <div class="col-md-4">
                              ...
                              <div class="service-card">
                                  <div class="service-header">
                                      <p class="service-title">{{ $item['tech_title'] }}</p>
    ...
    <div class="discussion-container">
      ...
      <div class="discussion-left">
        <img style="height: 250px" src="{{ asset('uploads/technology/'.$technology->image_path) }}" alt="Project Illustration">
      </div>
            ...
            <div class="row justify-content-center">
                @foreach ($expertise as $item)
                  <div class="col-md-3 col-sm-6">
                      <div class="tech-pill">
                          <img src="{{ asset('uploads/technology/'.$item['expertise_image']) }}" alt="" style="max-height:34px;"
                              @if(!empty($item['expertise_url'])) onclick="window.location='{{ $item['expertise_url'] }}'" style="cursor:pointer;" @endif>
                      </div>
                  </div>
