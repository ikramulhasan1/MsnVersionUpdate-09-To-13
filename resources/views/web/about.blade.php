...
@section('content')
  ...
  .msn-scope .container { max-width: 1180px; }
  ...
  .msn-reveal.is-visible { opacity: 1; transform: translateY(0); }
  @media (prefers-reduced-motion: reduce) {
    .msn-reveal { opacity: 1; transform: none; transition: none; }
  }

  /* ---- Section rhythm ---- */
  .msn-section { padding: clamp(64px, 9vw, 120px) 0; }
  .msn-section-head { max-width: 620px; margin-bottom: 48px; }
  .msn-section-head.msn-center { margin-left: auto; margin-right: auto; text-align: center; }
  .msn-section-head h2 {
  ...
  .msn-eyebrow::before {
    ...
    background: var(--ap-red); display: inline-block;
  }
  .msn-eyebrow-on-dark { color: var(--ap-red-line); }
  .msn-eyebrow-on-dark::before { background: var(--ap-red-line); }
  ...
  .msn-btn-primary:hover { opacity: .9; color: #fff; }
  ...
  .ap-chip {
    ...
    background: var(--hero-card-bg); border: 1px solid var(--hero-line);
    padding: 8px 16px; border-radius: 8px;
    color: var(--hero-fg-muted); margin-bottom: 26px;
  }
  .ap-chip .dot {
    width: 6px; height: 6px; border-radius: 50%;
    background: var(--hero-red); display: inline-block;
  }
  ...
  .ap-hero-copy {
    ...
    color: var(--hero-fg-muted); max-width: 500px;
    margin: 0 0 28px;
  }
  .ap-breadcrumb {
    font-family: var(--bp-font-mono);
  ...
  .ap-breadcrumb a { color: var(--hero-fg); text-decoration: none; }
  .ap-breadcrumb a:hover { color: var(--hero-red); }
  .ap-breadcrumb .sep { color: rgba(255,255,255,.25); }
  .ap-breadcrumb span:last-child { color: var(--hero-red); }
  ...
  .ap-hero .msn-btn-outline:hover { border-color: #fff; }
  ...
  .ap-hero-title .ap-accent { color: var(--hero-red); }
  ...
  .ap-seal-ring { width: 100%; height: 100%; animation: ap-spin 46s linear infinite; }
  ...
  .ap-seal-num {
    ...
    font-size: 1.7rem; color: var(--hero-fg); line-height: 1;
  }
  .ap-seal-label {
    font-family: var(--bp-font-mono); font-size: .6rem;
    letter-spacing: .16em; color: var(--hero-red); margin-top: 4px;
  }
  ...
  .about-content { color: var(--ap-muted); line-height: 1.8; font-size: .98rem; }
  ...
  .bp-frame img { width: 100%; height: 100%; object-fit: cover; display: block; aspect-ratio: 4/3; }
  .bp-crosshair {
    position: absolute; width: 16px; height: 16px; z-index: 2;
    border-color: var(--ap-red); opacity: .8;
  }
  .bp-crosshair.tl { top: 12px; left: 12px; border-top: 2px solid; border-left: 2px solid; }
  .bp-crosshair.tr { top: 12px; right: 12px; border-top: 2px solid; border-right: 2px solid; }
  .bp-crosshair.bl { bottom: 12px; left: 12px; border-bottom: 2px solid; border-left: 2px solid; }
  .bp-crosshair.br { bottom: 12px; right: 12px; border-bottom: 2px solid; border-right: 2px solid; }
  ...
  .ap-value-card:hover { background: var(--ap-bg-soft); }
  .ap-value-badge {
    width: 42px; height: 42px; border-radius: var(--ap-radius-sm);
    display: flex; align-items: center; justify-content: center;
    background: var(--ap-red-soft);
    color: var(--ap-red); font-size: 1.05rem; margin-bottom: 18px;
  }
  .ap-value-card h5 { font-family: var(--bp-font-display); font-weight: 700; margin-bottom: 8px; font-size: 1rem; }
  .ap-value-card p { color: var(--ap-muted); font-size: .9rem; line-height: 1.65; margin: 0; }

  /* ==========================================================================
     MISSION & VISION
     ========================================================================== */
  .ap-mv-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 24px; }
  .msn-card {
    background: var(--ap-white); border-radius: var(--ap-radius-lg);
    border: 1px solid var(--ap-line);
  }
  .ap-mv-card { position: relative; padding: 38px 32px; overflow: hidden; }
  .ap-mv-index {
    position: absolute; top: 20px; right: 26px;
    font-family: var(--bp-font-display); font-weight: 700;
    font-size: 2.6rem; color: var(--ap-bg-soft);
    line-height: 1; z-index: 0;
  }
  .ap-mv-icon {
    width: 46px; height: 46px; border-radius: 12px;
    display: flex; align-items: center; justify-content: center;
    background: var(--ap-ink); color: #fff; font-size: 1.05rem;
    margin-bottom: 20px; position: relative; z-index: 1;
  }
  .ap-mv-card--vision .ap-mv-icon { background: var(--ap-red); }
  .ap-mv-card h3 {
    font-family: var(--bp-font-display); font-weight: 700;
    font-size: 1.25rem; position: relative; z-index: 1; margin-bottom: 10px;
  }
  .ap-mv-card .about-content { position: relative; z-index: 1; }

  /* ==========================================================================
     WHAT WE PROVIDE
     ========================================================================== */
  .ap-provide-grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 20px; }
  .ap-provide-card {
    padding: 28px 22px; text-align: left;
    transition: border-color .25s ease;
  }
  .ap-provide-card:hover { border-color: var(--ap-red-line); }
  .ap-provide-icon {
    width: 44px; height: 44px; border-radius: var(--ap-radius-sm);
    display: flex; align-items: center; justify-content: center;
    background: var(--ap-bg-soft); color: var(--ap-red);
    font-size: 1.1rem; margin-bottom: 18px;
  }
  .ap-provide-card h5 { font-family: var(--bp-font-display); font-weight: 700; margin-bottom: 8px; font-size: 1rem; }
  .ap-provide-card p { color: var(--ap-muted); font-size: .9rem; line-height: 1.65; margin: 0; }
  ...
  .ap-marquee-label {
    ...
    color: var(--ap-muted-soft); margin-bottom: 16px;
  }
  .ap-marquee {
    display: flex; gap: 12px; width: max-content;
    animation: ap-marquee-scroll 34s linear infinite;
  }
  .ap-marquee-wrap:hover .ap-marquee { animation-play-state: paused; }
  .ap-marquee-item {
    display: inline-flex; align-items: center; gap: 8px;
    font-family: var(--bp-font-body); font-weight: 500; font-size: .86rem;
    color: var(--ap-ink);
    background: var(--ap-white);
    border: 1px solid var(--ap-line);
  ...
  .ap-marquee-item i { color: var(--ap-red); font-size: .95rem; }
  ...
  .ap-stat-col { flex: 1 1 200px; text-align: center; }
  .ap-stat { padding: 20px 10px; border-left: 1px solid var(--ap-line-dark); }
  .ap-stat-col:first-child .ap-stat { border-left: none; }
  .ap-stat-value {
    font-family: var(--bp-font-display); font-weight: 700;
    font-size: clamp(2rem, 3.6vw, 2.7rem);
    color: var(--ap-red-line); line-height: 1;
  }
  .ap-stat-label {
  ...
  .ap-team-inner:hover { border-color: var(--ap-red-line); }
  .ap-team-photo {
    width: 84px; height: 84px; border-radius: 50%;
    overflow: hidden; margin: 0 auto 16px;
    border: 1px solid var(--ap-line);
  }
  .ap-team-photo img { width: 100%; height: 100%; object-fit: cover; }
  .ap-team-name { font-family: var(--bp-font-display); font-size: 1rem; margin: 0 0 4px; }
  .ap-team-name a { color: var(--ap-ink); text-decoration: none; }
  .ap-team-role { display: block; color: var(--ap-red); font-size: .8rem; font-weight: 500; margin-bottom: 10px; }
  .ap-team-meta {
    display: block; font-size: .78rem; color: var(--ap-muted); margin-bottom: 4px;
  }
  .ap-team-social {
  ...
  .ap-team-social a {
    ...
    display: flex; align-items: center; justify-content: center;
    background: var(--ap-bg-soft); color: var(--ap-ink);
    font-size: .78rem; transition: background .2s ease, color .2s ease;
  }
  .ap-team-social a:hover { background: var(--ap-red); color: #fff; }
  ...
  .ap-quote-mark {
    font-family: var(--bp-font-display); font-size: 3rem;
    color: var(--ap-red); line-height: 1; display: block; margin-bottom: 6px;
  }
  .ap-quote-text {
    font-family: var(--bp-font-display); font-weight: 600;
    font-size: clamp(1.25rem, 2.4vw, 1.75rem);
    max-width: 740px; margin: 0 auto; line-height: 1.45;
  }
  .ap-quote-attrib {
    margin-top: 20px; font-family: var(--bp-font-mono);
  ...
  /* ==========================================================================
     PROCESS
     ========================================================================== */
  .ap-process-title { max-width: 620px; }
  .ap-process-step {
    background: var(--ap-white); border: 1px solid var(--ap-line);
    border-radius: var(--ap-radius-lg);
  ...
  .ap-process-step:hover { border-color: var(--ap-red-line); }
  .ap-process-number {
    font-family: var(--bp-font-display); font-weight: 700;
    font-size: 1.4rem; color: var(--ap-red);
    margin-bottom: 16px;
  }
  .ap-process-heading { font-family: var(--bp-font-display); font-weight: 700; font-size: 1.05rem; margin-bottom: 8px; }
  .ap-process-desc { color: var(--ap-muted); font-size: .9rem; line-height: 1.65; }
  .ap-process-arrow { position: relative; height: 0; }
  .ap-process-arrow::after {
    content: "\2192"; /* → */
    position: absolute; top: -74px; right: -32px;
    font-size: 1.2rem; color: var(--ap-muted-soft);
  }
  .ap-process-arrow.ap-arrow-down::after { content: "\2193"; top: auto; bottom: -44px; right: 50%; transform: translateX(50%); }
  .ap-process-arrow.arrow-hidden::after { content: ""; }

  /* ==========================================================================
     RESPONSIVE
     ========================================================================== */
  @media (max-width: 991px) {
    .ap-intro-grid { grid-template-columns: 1fr; gap: 32px; }
    .ap-intro-media { order: -1; }
    .ap-values-grid { grid-template-columns: repeat(2, 1fr); }
    .ap-mv-grid { grid-template-columns: 1fr; }
    .ap-provide-grid { grid-template-columns: repeat(2, 1fr); }
    .ap-team-grid { grid-template-columns: repeat(2, 1fr); }
    .ap-stats { justify-content: center; }
    .ap-stat { border-left: none; border-top: 1px solid var(--ap-line-dark); }
    .ap-stat-col:first-child .ap-stat { border-top: none; }
  }

  @media (max-width: 575px) {
    .msn-section { padding: 44px 0 64px; }
    .ap-hero { padding: 44px 0 56px; }
    .ap-hero-title { font-size: clamp(1.85rem, 9vw, 2.4rem); }
    .ap-seal { width: 120px; height: 120px; margin-top: 32px; }
    .ap-seal-num { font-size: 1.35rem; }
    .ap-values-grid,
    .ap-provide-grid,
    .ap-team-grid { grid-template-columns: 1fr; }
    .ap-stat { padding: 16px 6px; }
    .ap-quote-text { font-size: 1.25rem; }
    .ap-process-arrow::after,
    .ap-process-arrow.ap-arrow-down::after { display: none; }
  }
