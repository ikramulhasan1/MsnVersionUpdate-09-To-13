    ...
    <div class="msn-scope">
        ...
        <section class="ap-hero ap-grain">
            <div class="container ap-hero-inner">
                ...
                <p class="ap-hero-copy msn-reveal">Get to know the team, mission, and approach behind every project we
                    build.
                </p>
        ...
        <section class="ap-provide msn-section">
            <div class="container">
                <div class="msn-section-head msn-center msn-reveal">
                    ...
                    <h2>14+ Years of IT Excellence, Delivered Globally</h2>
                </div>
                ...
                <div class="ap-provide-grid">
                    ...
                    <div class="msn-card ap-provide-card msn-reveal">
                        ...
                        <p>High-performance, responsive websites crafted to deliver outstanding user experiences and
                            business
                            growth.</p>
                    </div>
                    <div class="msn-card ap-provide-card msn-reveal">
                        ...
                        <p>Seamless, high-impact mobile experiences designed to captivate users and expand your global
                            reach.</p>
                    </div>
                    <div class="msn-card ap-provide-card msn-reveal">
                    ...
                    <div class="ap-stats msn-reveal">
                        @foreach ($counters as $counter)
                            <div class="ap-stat-col">
                                <div class="ap-stat">
                                    <div class="ap-stat-value">{{ $counter->value }}</div>
                            ...
                            <div class="ap-team-block">
                                <div class="ap-team-inner">
                                    ...
                                    @if (isset($member->email))
                                        <span class="ap-team-meta"><i class="far fa-envelope"></i>
                                            {{ $member->email }}</span>
                                    @endif
                                    @if (isset($member->phone))
                                        <span class="ap-team-meta"><i class="fas fa-phone-volume"></i>
                                            {{ $member->phone }}</span>
                                    @endif
        ...
        <section class="ap-quote-band msn-reveal">
            <div class="container">
                ...
                <p class="ap-quote-text">We don't just ship projects. We build the software your business will still be
                    proud of
