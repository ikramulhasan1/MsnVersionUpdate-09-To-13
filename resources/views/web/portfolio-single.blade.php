      ...
      <div class="crumb-bar">
        <div class="wrap crumb-row">
          <div class="crumb-links">
            <a href="{{ url('/') }}">Home</a><span>/</span><a href="">Our
              Work</a><span>/</span><span>{{ $portfolio->title }}</span>
          </div>
          <div class="crumb-nav-arrows">
            <a href="#" class="crumb-arrow" aria-label="Previous project" title="Previous project"><svg
                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                stroke-linejoin="round">
                <path d="M15 18l-6-6 6-6" />
              </svg></a>
            <a href="#" class="crumb-arrow" aria-label="Next project" title="Next project"><svg viewBox="0 0 24 24"
          ...
          <div class="reveal">
            ...
            <div class="meta-grid">
              ...
              @if($portfolio->categories->count())
                <div class="meta-cell"><span>Category</span><b>{{ $portfolio->categories->pluck('title')->join(', ') }}</b>
                </div>
              @endif
              @if($portfolio->technologies->count())
                <div class="meta-cell">
                  <span>Technologies</span><b>{{ $portfolio->technologies->pluck('short_title')->join(', ') }}</b></div>
              @endif
            </div>
          </div>
          <div class="device-wrap reveal">
            <div class="browser-frame">
              ...
              <div class="browser-screen"
                style="background-image:url('{{ asset('uploads/portfolio/' . $portfolio->image_path) }}');"></div>
            </div>
      ...
      <section class="overview-section" id="overview">
        <div class="wrap overview-grid">
          ...
          <div class="challenge-box reveal">
            <h3><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"
                stroke-linejoin="round">
                <path d="M12 9v4" />
                <path d="M12 17h.01" />
              ...
              @foreach ($screenshotImage as $item)
                <div class="gallery-card reveal">
                  <div class="gallery-shot"
                    style="background-image:url('{{ asset('uploads/screenshot/' . $item['screenshot_image']) }}');"></div>
        ...
        <div class="wrap">
          <div class="next-project-row reveal">
            <a href="#" class="np-link prev">
              <span class="np-label"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                  stroke-linecap="round" stroke-linejoin="round">
                  <path d="M15 18l-6-6 6-6" />
            ...
            <a href="#" class="np-link next">
              <span class="np-label">Next Project<svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
