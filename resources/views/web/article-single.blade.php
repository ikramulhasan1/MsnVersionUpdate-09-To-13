                                ...
                                <div class="inner">
                                    ...
                                    @if(isset($page_quote))
                                        ...
                                        <div class="service-title mb-3">
                                            <h5 style="font-weight: 600" >Are you interested in <b style="color: #00893b">{{ $article->short_title }}</b> service? <span style="color: red">contact me</span></h5> <!-- Title text -->
                                        </div>
