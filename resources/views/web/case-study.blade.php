        ...
        <section class=" container" style="background-color: #ffffff;">
            <div class="col-lg-8">
                ...
                @if (!empty($case->case_title) && $case->case_title == 'The Challenges')
                  ...
                  <div class="caseStudy-section-box">
                    ...
                    <ul class="caseStudy-check-list">
                        ...
                        <li>Security risks emerged due to reliance on physical document handling, increasing compliance
                            concerns.
                        </li>
                    </ul>
                ...
                <div class="caseStudy-section pb-5">
                    ...
                    <p><strong>Microservices Architecture:</strong> Developed a scalable and adaptable infrastructure to
                        support
                        future growth.</p>
                    ...
                    <div class="caseStudy-integrations">
                        <div class="caseStudy-integration-item">
                            ...
                            <div class="integration-text"><strong>DocuSign:</strong> Enabled secure and legally binding
                                electronic
                                signatures.</div>
                        </div>
                        <div class="caseStudy-integration-item">
                        ...
                        <div class="caseStudy-integration-item">
                            <div class="caseStudy-dot"></div>
                            <div class="integration-text"><strong>Twilio:</strong> Integrated secure video conferencing for
                                remote
                                client-advisor interactions.</div>
                        </div>
                        <div class="caseStudy-integration-item">
                            <div class="caseStudy-dot"></div>
                            <div class="integration-text"><strong>Xero:</strong> Automated financial operations, including
                                invoicing
                                and accounting.</div>
                        </div>
                        <div class="caseStudy-integration-item">
