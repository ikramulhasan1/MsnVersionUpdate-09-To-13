...
@section('content')
  ...
  <div class="svc-scope">
    @php
      ...
      $svcIcons = ['fa-palette', 'fa-mobile-screen', 'fa-robot', 'fa-cloud-arrow-up', 'fa-list-check', 'fa-diagram-project'];
    @endphp
                  ...
                  <div class="col-12 col-md-6 col-lg-4">
                      <a href="{{ route('service.single', $service->slug) }}"
                          ...
                          @if(isset($service->description))
                            <p class="svc-service-desc">{{ str_limit(strip_tags($service->description), 130, '...') }}</p>
                          @endif
