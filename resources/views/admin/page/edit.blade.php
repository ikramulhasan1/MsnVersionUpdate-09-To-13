            ...
            <div class="card">
                ...
                <form class="needs-validation" novalidate action="{{ route($route.'.update', $row->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="status">{{ __('Select Type') }}</label>
                            <select class="wide" name="type" id="status" data-plugin="customselect">
                                <option value="casestudy" @if( $row->type == 'casestudy' ) selected @endif>{{ __('Case Study') }}</option>
                                <option value="resources" @if( $row->type == 'resources' ) selected @endif>{{ __('Resources') }}</option>
                                <option value="footer" @if( $row->type == 'footer' ) selected @endif>{{ __('Footer') }}</option>
                            </select>
                        </div>
