                        ...
                        <div class="card-body">
                            ...
                            <div id="Services" class="case-services p-2 mb-3">
                                @foreach($services as $service)
                                    <input name="services[]" type="checkbox" value="{{ $service->id }}" {{ (is_array(old('services')) && in_array($service->id, old('services'))) ? 'checked' : '' }} id="services-{{ $service->id }}"><label
                                        for="services-{{ $service->id }}">{{ $service->short_title }}</label>
                                @endforeach
                            </div>
                            ...
                            <div class="row process-row">
                                <div class="form-group col-9 faq-group mb-2">
                                    {{-- <input type="text" class="form-control mb-1" name="case[0][case_title]"
                                        placeholder="Title"> --}}
                                    {{-- <select name="case[0][case_title]" class="form-select"
                                    ...
                                    <div class="form-group col p-0">
                                        ...
                                        <select class="wide" name="case[0][case_title]" id="status"
