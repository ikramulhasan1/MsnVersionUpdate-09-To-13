            ...
            <div class="col-12 col-lg-12">
                <div class="card">
                    ...
                    <form class="needs-validation" novalidate
                        action="{{ route($route . '.update', ['case_study' => $row->id]) }}" method="post"
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input type="text" class="form-control" name="short_title" id="short_title"
                                        value="{{ $row->short_title }}" required>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col">
                                    ...
                                    <input type="number" class="form-control" name="review_count" id="review_count"
                                        value="{{ $row->review_count }}" required>
                                ...
                                <div class="form-group col">
                                    ...
                                    <input type="text" class="form-control" name="priceCurrency" id="priceCurrency"
                                        value="{{ $row->priceCurrency }}" required>
                                ...
                                <div class="form-group col-10 faq-group mb-2 row">
                                    ...
                                    <div class="col-11">
                                        <input type="text" class="form-control mb-1" name="faqs[{{ $key }}][title]"
                                            value="{{ $faq->title }}" placeholder="{{ $key+1 }}. Question" required>
                                        <input type="text" class="form-control mb-1" name="faqs[{{ $key }}][description]"
                                            value="{{ $faq->description }}" placeholder="{{ $key+1 }}. Answer" required>
                                        <input type="hidden" class="form-control mb-1" name="type" value="{{ $faq->type }}"
                                            required>
                                        <select hidden name="faqs[{{ $key }}][category_id]">
                                            @foreach ($faqCategories as $category)
                                            <option value="{{ 12 }}" @if($category->id == $faq->category_id) selected
                            ...
                            <div class="row process-row">
                                        ...
                                        <div class="col-11">
                                            ...
                                            <div class="d-flex">
                                                <input type="file" class="form-control mb-1 mr-3 w-75"
                                                    name="workprocess[{{ $key }}][process_image]">
                                                <img style="width: 40px; height: 40px;"
                                                    src="{{ asset('uploads/process/' . $process->image_path) }}"
                                ...
                                <div class="form-group col-2">
                                    <button class="btn btn-success" type="button"
                                        onclick="addProcess()">{{ __('dashboard.add_work_process') }}</button>
                                </div>
                                <br><br>
                            </div>
                            <hr> --}}
                            ...
                            <div class="row industry-row">
                                ...
                                @foreach ($row->industries as $key => $industry)
                                    <div class="form-group col-10 industry-group mb-2 row align-items-center"
                                        ...
                                        <div class="col-1">
                                            <button type="button" class="btn btn-danger btn-sm"
                                                onclick="removeIndustry(this)">✕</button>
                                        </div>
                                        <div class="col-1">
                                            <button type="button" class="btn btn-danger btn-sm"
                                                onclick="deleteIndustry({{ $industry->id }})">🗑️ Delete</button>
                                        </div>
                                    </div>
                                @endforeach
                            ...
                            <div class="row whywes-row">
                                @foreach ($row->whywes as $key => $we)
                                    <div class="form-group col-10 whywes-group mb-2 row align-items-center"
                                        id="whywes-{{ $we->id }}">
                                        <div class="col-1">
                                            {{ $key + 1 }}.
                                        </div>
                                        ...
                                        <div class="col-1">
                                            <button type="button" class="btn btn-danger btn-sm"
                                                onclick="removeWhyWe(this)">✕</button>
                                        </div>
                                        <div class="col-1">
                                            <button type="button" class="btn btn-danger btn-sm"
                                                onclick="deleteWhyWe({{ $we->id }})">🗑️ Delete</button>
                                        </div>
                                    </div>
                                @endforeach
