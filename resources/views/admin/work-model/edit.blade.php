                ...
                <form class="needs-validation" novalidate action="{{ route($route.'.update', $row->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="short_description" id="editor1" rows="8" required>{!! $row->short_description !!}</textarea>
                        ...
                        <div style="background-color: #eeffee; padding: 15px;">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="meta_description" id="editor2" rows="2" required>{!! $row->meta_description !!}</textarea>
