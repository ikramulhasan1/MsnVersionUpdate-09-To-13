                                ...
                                <tbody>
                                    @foreach ($rows as $key => $row)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.technologies.show', [$row->id]) }}"
                                                    class="btn btn-success btn-sm">
                                                    <i class="fas fa-eye"></i>
                                                </a>

                                                <a href="{{ route('admin.technologies.edit', [$row->id]) }}"
                                                ...
                                                <div class="modal fade" id="deleteModal-{{ $row->id }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog modal-sm">
                                                        <form
                                                            action="{{ route('admin.technologies.destroy', [$row->id]) }}"
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <button type="submit"
                                                                        class="btn btn-danger">{{ __('dashboard.confirm') }}</button>
