                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="wide" name="service_id" id="service_id" data-plugin="customselect">
                                    @foreach ($services as $service)
                                        <option value="{{ $service->id }}" @if ($subservice->service_id == $service->id) selected
                                        @endif>
                                            {{ $service->title }}
                                        </option>
                                    @endforeach
                            ...
                            <div class="row process-row-toggle">
                                @foreach ($tech as $index => $item)
                                    <div class="form-group col-9 faq-group mb-2">
                                        <input type="text" value="{{ $item['tech_title'] }}" class="form-control mb-1"
                                            name="tech[{{ $index }}][tech_title]" placeholder="Title">
                                        <textarea id="editor_toggle_{{ $index }}" class="form-control mb-1"
                            ...
                            <div class="row process-row-expertise">
                                @foreach ($expertise as $index => $item)
                                    <div class="form-group col-9 faq-group mb-2">
                                        <input type="text" value="{{ $item['expertise_url'] }}" class="form-control mb-1"
                            ...
                            <div class="row">
                                <div class="form-group col-6">
                                    ...
                                    @if(!empty($subservice->image_path))
                                        <div class="mb-1">
                                            <img src="{{ asset('uploads/' . $path . '/' . $subservice->image_path) }}" alt="CTA Image"
                                                style="height:80px;">
                                        </div>
                                    @endif
                                ...
                                <div class="form-group col-6">
                                    ...
                                    @if(!empty($subservice->logo_path))
                                        <div class="mb-1">
                                            <img src="{{ asset('uploads/' . $path . '/' . $subservice->logo_path) }}" alt="Logo"
                                                style="height:80px;">
                                        </div>
                                    @endif
