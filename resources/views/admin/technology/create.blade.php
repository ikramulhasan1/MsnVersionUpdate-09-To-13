    ...
    <div class="row">
        <div class="col-12 col-lg-12">
            <div class="card">
                ...
                <form action="{{ route('admin.technologies.store') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="row process-row-toggle">
                            <div class="form-group col-9 mb-2">
                                <input type="text" name="tech[0][tech_title]" class="form-control mb-1" placeholder="Title">
                                <textarea name="tech[0][tech_description]" class="form-control mb-1" placeholder="Description"></textarea>
                            </div>
                        ...
                        <div class="row process-row-expertise">
                            <div class="form-group col-9 mb-2">
                                <input type="text" name="expertise[0][expertise_url]" class="form-control mb-1" placeholder="Url">
                            ...
                            <div class="form-group col-3">
                                <button type="button" class="btn btn-success" onclick="addExpertise()">Add Expertise</button>
                            </div>
                        </div>
