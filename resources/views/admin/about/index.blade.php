        ...
        <div class="card-body">
          ...
          <form class="needs-validation" novalidate action="{{ route($route.'.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" name="description" id="editor" rows="8" required>{{ isset($row->description)?$row->description:'' }}</textarea>
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="mission_desc" id="editor1" rows="8">{{ isset($row->mission_desc)?$row->mission_desc:'' }}</textarea>
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="vision_desc" id="editor2" rows="8">{{ isset($row->vision_desc)?$row->vision_desc:'' }}</textarea>
