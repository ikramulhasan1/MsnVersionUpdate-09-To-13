            ...
            <div class="card">
                ...
                <form class="needs-validation" novalidate action="{{ route($route.'.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            {{-- <div class="form-group col">
                                ...
                                <select class="form-control" name="category" id="category" required>
                                    ...
                                    <option value="{{ $category->id }}" @if(old('category')==$category->id) selected @endif style="color: black !important;" >{{ $category->title }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group">
                            <label for="short_description">{{ __('dashboard.short_desc') }} <span>*</span></label>
                            <textarea class="form-control" name="short_description" id="editor" rows="8" required>{{ old('short_description') }}</textarea>
                        ...
                        <div style="background-color: #eeffee; padding: 15px;">
                            ...
                            <div class="form-group">
                                <label for="meta_description">{{ __('dashboard.meta_description') }} <span>*</span></label>
                                <textarea class="form-control" name="meta_description" id="editor2" rows="2" required>{{ old('meta_description') }}</textarea>
